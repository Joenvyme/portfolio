      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col">
        ...
        <div className="flex animate-fade-up items-center justify-between font-mono text-[11px] uppercase tracking-[0.25em] text-bone-faint">
          <span className="flex items-center gap-2">
            <span className="inline-block h-1.5 w-1.5 animate-pulse rounded-full bg-bone" />
            Available — 2026
          </span>
        ...
        <div className="relative flex flex-1 items-center justify-center">
          ...
          <div className="z-10 mb-[-1.5rem] md:absolute md:left-1/2 md:top-1/2 md:mb-0 md:-translate-x-1/2 md:-translate-y-[66%]">
            <Image
              ...
              height={620}
              priority
              className="animate-float h-auto w-[52vw] max-w-[300px] drop-shadow-[0_25px_70px_rgba(0,0,0,0.8)] md:w-[30vw] md:max-w-[380px]"
            />
          </div>
        ...
        >
          <div>
            <p className="font-display text-xl font-semibold tracking-tight text-bone md:text-2xl">
              Creative Developer
            </p>
            <p className="mt-2 font-mono text-[11px] uppercase tracking-[0.25em] text-bone-faint">
              by Joey Montani
            </p>
          </div>
